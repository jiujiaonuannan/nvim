...
_G.packer_plugins = {
  ...
  ["gruvbox.nvim"] = {
    loaded = true,
    path = "/Users/user/.local/share/nvim/site/pack/packer/start/gruvbox.nvim",
  ...
  ["lush.nvim"] = {
    loaded = true,
    path = "/Users/user/.local/share/nvim/site/pack/packer/start/lush.nvim",
  ...
  ["nord.nvim"] = {
    loaded = true,
    path = "/Users/user/.local/share/nvim/site/pack/packer/start/nord.nvim",
  ...
  ["oceanic-next"] = {
    loaded = true,
    path = "/Users/user/.local/share/nvim/site/pack/packer/start/oceanic-next",
  ...
  ["surround.nvim"] = {
    loaded = true,
    path = "/Users/user/.local/share/nvim/site/pack/packer/start/surround.nvim",
    url = "https://github.com/ur4ltz/surround.nvim"
  },
  ["telescope-env.nvim"] = {
    loaded = true,
    path = "/Users/user/.local/share/nvim/site/pack/packer/start/telescope-env.nvim",
